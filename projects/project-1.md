...
For the storytelling of the audio guides to achieve a high level of realism and immersiveness, we aimed to reproduce the exact acoustics of the targeted sites by capturing the impulse response of the different rooms in Ambisonics, from different positions, including at different distances from the microphone's position. This led to a discretized cartography of the 3D reverberation of the room.<br />
